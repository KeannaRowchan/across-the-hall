...
export function Directory({ onBackToHall }: { onBackToHall: () => void }): JSX.Element {
      ...
      <header className="masthead">
        <div className="masthead-inner">
          <div className="wordmark">
            <button type="button" className="back-to-hall" onClick={onBackToHall}>
              <span aria-hidden="true">&larr;</span> Hallway
            </button>
